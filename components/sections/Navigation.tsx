...
export function Navigation() {
  ...
  return <header className="nav"><div className="mic-container nav-inner">
    ...
    <nav className={`nav-links ${open ? "nav-open" : ""}`}>
      <a href="#business" onClick={() => setOpen(false)}>Business</a><a href="#market-pulse" onClick={() => setOpen(false)}>Markets</a><a href="#opportunities" onClick={() => setOpen(false)}>Opportunities</a><a href="#founders" onClick={() => setOpen(false)}>Founders</a>
    </nav>
