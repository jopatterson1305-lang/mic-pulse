  ...
  return <section className="hero" id="top">
    ...
    <div className="mic-container hero-inner">
      <div className="hero-copy">
        ...
        <div className="hero-bottom"><p>Business, technology, finance and opportunity intelligence for the people building East Africa&apos;s future.</p><a className="primary-button" href="#intelligence">Explore MIC <span>↓</span></a></div>
      </div>
